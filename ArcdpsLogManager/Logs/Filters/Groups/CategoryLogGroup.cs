...
namespace GW2Scratch.ArcdpsLogManager.Logs.Filters.Groups
{
	...
	public class CategoryLogGroup : LogGroup
	{
		private static readonly Dictionary<EncounterCategory, string> CategoryNames = new Dictionary<EncounterCategory, string>
		{
			...
			{EncounterCategory.StrikeMissionIcebroodSaga, "Icebrood Saga (IBS)"},
			{EncounterCategory.StrikeMissionEndOfDragons, "End of Dragons (EoD)"},
			{EncounterCategory.StrikeMissionSecretsOfTheObscure, "Secrets of the Obscure (SotO)"},
			{EncounterCategory.StrikeMissionFestival, "節慶"},
