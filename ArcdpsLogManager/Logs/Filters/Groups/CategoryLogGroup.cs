...
namespace GW2Scratch.ArcdpsLogManager.Logs.Filters.Groups
{
	...
	public class CategoryLogGroup : LogGroup
	{
		private static readonly Dictionary<EncounterCategory, string> CategoryNames = new Dictionary<EncounterCategory, string>
		{
			...
			{EncounterCategory.RaidEncounterIcebroodSaga, "Icebrood Saga (IBS)"},
			{EncounterCategory.RaidEncounterEndOfDragons, "End of Dragons (EoD)"},
			{EncounterCategory.RaidEncounterSecretsOfTheObscure, "Secrets of the Obscure (SotO)"},
			{EncounterCategory.RaidEncounterVisionsOfEternity, "Visions of Eternity (VoE)"},
			{EncounterCategory.RaidEncounterFestival, "節慶"},
			{EncounterCategory.Fractal, "迷霧碎層 (FotM)"},
			{EncounterCategory.FractalNightmare, "噩夢" },
			{EncounterCategory.FractalShatteredObservatory, "破碎觀測台" },
